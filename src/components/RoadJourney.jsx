...
// A deliberately asymmetric silhouette (wedge nose + headlight on the right,
// taller cabin toward the back-left) so "facing right" reads unambiguously —
// a symmetric car looks the same whichever way it's mirrored, which was the
// actual bug: the flip logic was fine, the car just had no visible front.
function Car({ innerRef }) {
  return (
    <div ref={innerRef} style={{ width: CAR_W, height: CAR_H }}>
      <svg width={CAR_W} height={CAR_H} viewBox="0 0 76 42" aria-hidden="true">
